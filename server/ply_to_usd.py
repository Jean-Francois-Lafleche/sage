...
def ply_to_usd(ply_path: str, usd_path: str, texture_path: str = None, texture_rel_path: str = None) -> bool:
    ...
    with open(usd_path, 'w') as f:
        ...
        # Material binding - use relative binding path for composition
        if has_texture:
            f.write('    rel material:binding = <Material>\n')
        
            # Material definition nested inside Mesh prim
            # Use relative paths (./) for connections within the same scope
            f.write('\n')
